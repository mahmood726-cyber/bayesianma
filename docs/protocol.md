        # Bayesianma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/bayesianma.git

        ## Objective

        BayesianMA is a browser-based Bayesian random-effects meta-analysis tool with grid approximation, prior sensitivity analysis, and posterior credible interval reporting.
        ...
        - Code: https://github.com/mahmood726-cyber/bayesianma.git
        - Dashboard: https://mahmood726-cyber.github.io/bayesianma/
